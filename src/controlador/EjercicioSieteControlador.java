...
public class EjercicioSieteControlador implements Initializable {
    ...
    private void agregarPersona(ActionEvent event) {
        ...
        try {
            ...
            // Cargo la vista
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/EjercicioSieteDialog.fxml"));

            // Cargo la ventana
            Parent root = loader.load();

            // Cojo el controlador
            EjercicioSieteControladorDialog controlador = loader.getController();
