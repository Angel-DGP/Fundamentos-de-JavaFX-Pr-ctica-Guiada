...
public class EjercicioSeisControlador implements Initializable {
    ...
    private void agregarPersona(ActionEvent event) {
        try {
            // Cargo la vista
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/EjercicioSeisDialog.fxml"));

            // Cargo la ventana
            Parent root = loader.load();

            // Cojo el controlador
            EjercicioSeisControladorDialog controlador = loader.getController();
